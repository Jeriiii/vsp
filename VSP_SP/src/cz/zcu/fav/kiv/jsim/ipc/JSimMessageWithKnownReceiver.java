...
/**
 * All message classes implementing this interface assure that their receiving process can be obtained and it is a single specific process,
...
} // interface JSimMessageWithKnownReceiver
